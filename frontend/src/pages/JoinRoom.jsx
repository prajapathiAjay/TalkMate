...
const JoinRoom = ({ onJoin, currentUser }) => {
  ...
  if (currentUser) {
    return (
      <div className="w-[400px] h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-8 flex flex-col justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-6">
            <div className="w-20 h-20 bg-gradient-to-r from-green-400 to-blue-500 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
  ...
  return (
    <div className="w-[400px] h-screen bg-gradient-to-br from-blue-500 to-purple-600 p-8 flex flex-col justify-center">
